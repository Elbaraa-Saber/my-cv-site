...
export const OldProjects = ({ className, selectedLang }: Props) => {
  return (
    <div className="oldProjects">
      <h3 className="oldProjects__title">
        {selectedLang === "Russian" ? (
          <>Мои проекты во время обучения</>
        ) : (
          <>My projects during my studies</>
        )}
      </h3>
      <div className="container oldProjects__container">
